...
@click.option(
    "--input_path",
    prompt="Path to the folder containing your pdfs",
    help="Specifies the location of the pdfs",
    required=True,
)
@click.option(
    "--output_path",
    prompt="Path to folder to export the images",
    help="Specifies where the images will be saved",
    required=True,
)
